...
const journey = [
  {
    ...
    photo: "/photos/20260221_160304.jpg",
  },
  {
    year: "NxtStepEdu",
    ...
    photo: "/photos/20260221_160329.jpg",
  },
  {
    year: "LockedIn",
...
function Polaroid({
  ...
  return (
    <div className={`${size} ${rotate} shrink-0`}>
      <div className="bg-[#FFFCF5] border-4 border-[#14121F] rounded-sm p-2 pb-5 shadow-[6px_6px_0_0_rgba(20,18,31,0.25)]">
        <Image
          src={src}
          alt={alt}
          width={300}
  ...
  return (
    <div className="relative flex flex-col flex-1 text-[#14121F] overflow-x-hidden">
      ...
      <section className="relative border-b-4 border-[#14121F] px-6 sm:px-12 pt-20 pb-16">
        <div className="hero-badge inline-block -rotate-2 bg-[#FFD93D] border-4 border-[#14121F] rounded-full px-5 py-1.5 mb-8 font-display font-semibold text-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto] gap-10 items-start">
          <div>
            <h1 className="font-display font-bold leading-[0.9] tracking-tight text-[15vw] sm:text-[6.5rem] md:text-[7.5rem]">
              Sridhar
            </h1>
      ...
      <section
        id="life"
        className="px-6 sm:px-12 py-20 border-b-4 border-[#14121F]"
      >
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-lg text-[#14121F]/70 max-w-md">
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-5">
          ...
          <div className="md:col-span-2 rounded-3xl bg-[#14121F] border-4 border-[#14121F] p-8 flex flex-col justify-center">
            <p className="font-display font-bold text-5xl text-[#FFD93D]">
              CSE
            </p>
      ...
      <section className="px-6 sm:px-12 py-20 border-b-4 border-[#14121F]">
        ...
        <div className="flex flex-col gap-0">
          {journey.map((item, i) => (
            <div
              key={item.title}
              className="flex flex-col sm:flex-row gap-6 sm:gap-10 py-8 border-t-4 border-[#14121F] first:border-t-0 items-start"
            >
